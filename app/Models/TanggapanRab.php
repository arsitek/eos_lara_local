...
class TanggapanRab extends Model {
    protected $connection = 'sirekat';
    use HasFactory;
    protected $table = "tb_tanggapan";
    protected $fillable = ["id_rab", "role", "tanggapan", "jenis_rab"];

    /**
     * Membentuk status dan isi tooltip berdasarkan verifikator yang benar-benar menolak.
     */
    public static function getRejectionInfo($rab, $tanggapan): array
    {
        $verificationMap = [
            [
        ...
        foreach ($verificationMap as $verification) {
            if ($rab->{$verification["column"]} !== "Tolak") {
                continue;
            }
