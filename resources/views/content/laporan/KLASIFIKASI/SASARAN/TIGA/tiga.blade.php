...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header"><h3 class="card-title">SKK | Meningkatnya kualitas kurikulum dan pembelajaran</h3></div>
        <div class="card-body">
            <div>
                <a href="#" onclick="ExportToExcel('xlsx')" class="btn btn-info px-2 py-1 mb-2">Save to XLSX</a>
                <a href="{{ route('rka.tiga.pdfNonApbn') }}" class="btn btn-info px-2 py-1 mb-2">Save to PDF</a>
            </div>
    ...
    <script>
        function ExportToExcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('Laporan_RKT_SASARAN_3.' + (type || 'xlsx')));
        }
    </script>
@endpush
