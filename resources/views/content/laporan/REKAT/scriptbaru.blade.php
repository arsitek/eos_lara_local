			...
			success:function(data){
                ...
                rekat_coa.forEach((item,index) => {
                    $(".dk").each(function(){
                        ...
                        if( item.unit_kerja == uk && item.id_sub_judul == sj){
                        ...
                        if(item.rk_rekat == rincian_komponen && item.idunit == uk.replace(" ", "") && sj == item.id_sub_judul){
                            if(item.id_belanja_keg == id_belanja || item.id_belanja_per == id_belanja || item.id_belanja_gdg == id_belanja){
                                $(this).parent().after(`<tr class="kk_row">
                                    ...
                                    <td>${item.satuan_keg ? item.satuan_keg : 'Pkt'}</td>
                ...
                sum_dk.forEach((item, index) => {
                    $(".dk").each(function(){
                        ...
                        if(uk == item.unit_kerja && id_dk == item.id_sub_judul && item.kd_rk.replace("[", "").substring( 3 )){
                ...
                sum_ikk.forEach((item, index) => {
                    $('.ikk_text').each(function(){
                        ...
                        if( ik_td[1]  == item.indikator_kinerja_kegiatan.split("] ")[0].substring(5) ){
                            let ikk_td = `<td style="text-align: right;">${item.TOTAL_IKK}</td><td></td><td></td><td></td>`
