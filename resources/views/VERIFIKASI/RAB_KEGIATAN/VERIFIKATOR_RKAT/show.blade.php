        ...
        <div class="col-lg-12">
            <div class="card relative">
                ...
                <div class="card-body">
                        ...
                        <table class="tabel-verkeg table table-bordered border mb-0" id="new-edit">
                            ...
                            <tr>
                                ...
                                @if( $isCrud == 1 )
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn-edit-modal text-white" href="/verifikasi/kegiatan/edit/{{ $item->id }}?kd_sumberdana={{ $kd_sumberdana}}" target="_blank">
                    ...
                    @include("VERIFIKASI.RAB_KEGIATAN.modalSetuju")
...
@push("scripts")
    ...
    @include("VERIFIKASI.RAB_KEGIATAN.VERIFIKATOR_RKAT.script")
