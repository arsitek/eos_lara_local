                        ...
                        <table class="tabel-verper table table-bordered border mb-0" id="new-edit">
                            ...
                            @foreach($rabper as $item)
                                <tr>
                                    ...
                                    <td class="aset">{{ $item->kode_aset ?
                                            '['.$item->kode_aset.']'.$item->aset
                                        : '-' }}</td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn-edit-modal text-white" href="/verifikasi/peralatan/edit/{{ $item->id }}?kd_sumberdana={{ $kd_sumberdana}}" target="_blank">
