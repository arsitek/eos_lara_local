        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h3 class="card-title">PEMUTAKHIRAN RENCANA KEBUTUHAN SARANA</h3>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="tabel-verper table table-bordered border mb-0" id="new-edit">
                            ...
                            <tr>
                                ...
                                <th class="align-middle text-center" rowspan="2">COA</th>
                                <th class="align-middle text-center" rowspan="2">KEBUTUHAN KEGIATAN</th>
                                <th class="align-middle text-center" rowspan="2">SPESIFIKASI</th>
                                <th class="align-middle text-center" rowspan="2">JUMLAH BIAYA</th>
                            ...
                            @foreach($rabper as $item)
                                <tr>
                                    ...
                                    <td> {{ $item->rpd ?? "-" }} </td>
                                    <td>
                                        <select name="jenis_belanja" style="width:300px" class="s jenis_belanja">
                                            <option value="{{$item->id_jenis_belanja}}">{{ $item->id_jenis_belanja }} | {{ $item->jenis_belanja }}</option>
                                            @foreach($jenis_belanja as $item_coa)
                                            <option value="{{ $item_coa->coa }}" {{ $item_coa->coa == $item->id_jenis_belanja ? 'selected' : ''}}>{{ $item_coa->coa }} | {{ $item_coa->nama }}</option>
                                            @endforeach
...
@endsection
@push("scripts")
    @include("VERIFIKASI.RAB_PERALATAN.VERIFIKATOR_KEU.script")
