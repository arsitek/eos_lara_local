                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="tabel-verper table table-bordered border mb-0" id="new-edit">
                            ...
                            <tr>
                                <th class="align-middle text-center">SPI</th>
                            </thead>
                            <tbody>
                            @if( null !== request()->kd_sumberdana )
                    ...
                    @include("VERIFIKASI.RAB_PERALATAN.modalTanggapan")
                </div>
            </div>
        </div>
    </div>
...
@push("scripts")
    ...
    @include("VERIFIKASI.RAB_PERALATAN.SPI.script")
