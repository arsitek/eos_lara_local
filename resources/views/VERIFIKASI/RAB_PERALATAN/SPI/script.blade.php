<script>
    $(document).ready(function() {
        // Jalur SPI dipisahkan agar filter dan simpan tidak memakai endpoint umum Peralatan.
        ...
        $(document).on("click", ".btn-filter-unitkerja", function(){
            ...
            window.open(`/verifikasi/peralatan-spi/${idunit.val()}?kd_sumberdana=${kodeSd.val()}`, "_self")
        })
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        error: function ( error ) {
                            const msg = error.responseJSON?.message || "Gagal menyetujui peralatan"
        ...
        $(document).on("click", ".switchVerifikasi", (e) => {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('vRabPerSpi.storeVerif') }}",
