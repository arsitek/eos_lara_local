<script>
    $( document ).ready( function() {
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        error: function ( request, status, error ) {
                            const msg = ((request.responseJSON && request.responseJSON.message)) || "Gagal menyetujui BHP"
        ...
        $(document).on("click", "#btn_triggerTanggapan", function(){
            ...
            $.ajax({
                type: 'GET',
                url: "{{ route('vRabBhp.get.tanggapan') }}",
                data: { id },
                success: ( res ) => {
                    // clear tanggapan
        ...
        $(document).on("click", "button.btn_setujuiTanggapan", function(){
            ...
            $.ajax({
                ...
                error: ( err ) => {
                    const message = ((err.responseJSON && err.responseJSON.message)) || "Terjadi kesalahan saat menyimpan data"
        ...
        $( document ).on( "click", ".btn_simpanTanggapan", function(){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('vRabBhp.storeTanggapan') }}",
