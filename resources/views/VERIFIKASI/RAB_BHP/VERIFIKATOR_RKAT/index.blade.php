                        ...
                        <table class="tabel-verper table table-bordered border mb-0" id="new-edit">
                            ...
                            @foreach($rabbhp as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn-edit-modal text-white" href="/verifikasi/bhp/edit/{{ $item->id }}?kd_sumberdana={{ $kd_sumberdana}}" target="_blank">
...
@endsection
@push("scripts")
    @include("VERIFIKASI.RAB_BHP.VERIFIKATOR_RKAT.script")
