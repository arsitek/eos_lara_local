<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('click', ".save_btn", function (e) {
            ...
            let sasaran_program            = setiapBaris[2]
            let indikator_kinerja_kegiatan = setiapBaris[3]
            let rincian_kegiatan           = setiapBaris[4]
            ...
            let tanggapan				   = setiapBaris[7]
            let kriteria				   = setiapBaris[4]
            $.ajax({
                type: 'POST',
                ...
                console.log(verifikasi_tim, verifikasi_pimpinan)
            ...
            error: function (request, status, error) {
                tata.error('Galat', 'gagal menyimpan data', {
                    duration: 3000,
                    animate:slide
                })
            }
