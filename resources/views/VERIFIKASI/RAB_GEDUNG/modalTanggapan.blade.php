        ...
        <div class="modal-body">
            <table class="table mb-0" id="tabel-rekap-tanggapan" style="font-size: 16px">
                ...
                <tbody class="bodyTblTanggapan">
                    ...
                    @php
                        // Role SPI memiliki baris tanggapan sendiri agar catatan tersimpan sesuai role login.
                        $isEditable = in_array($role, ['Pengawasan Internal', 'Verifikator RKAT', 'superadmin']) ? 'true' : 'false';
                        $isOpEditable = in_array($role, ['operator', 'superadmin']) ? 'true' : 'false';
                    @endphp
                    <tr>
                    ...
                    @php
                        // Auditor dipisahkan dari Pengawasan Internal supaya riwayat tanggapan tidak tertukar.
                        $isEditable = in_array($role, ['Auditor', 'Verifikator RKAT', 'superadmin']) ? 'true' : 'false';
                        $isOpEditable = in_array($role, ['operator', 'superadmin']) ? 'true' : 'false';
                    @endphp
                    <tr>
                        <td>Auditor</td>
