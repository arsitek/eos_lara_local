                    ...
                    <div class="table-responsive">
                        ...
                        <table class="tabel-vergdg table table-bordered border mb-0">
                            ...
                            <tr>
                                ...
                                <th class="align-middle text-center" rowspan="2">SPEK</th>
                            ...
                            @foreach($rabgdg as $item)
                                <tr>
                                    ...
                                    <td class="spek">1 Paket X {{ $item->formatted_jumlah_nilai }} </td>
                                    <td> {{ $item->formatted_jumlah_nilai }}</td>
                                    <td>
                                        <label class="switch">
                                            <input type="checkbox" class="switchVerifikasi" data-jenis="verifikasiAset"
                                            {{ $item->verifikasi_aset == 'Setuju' ? 'checked' : ''}} @if( $isVerifikator == false ) disabled @endif>
...
@endsection
@push("scripts")
    @include("VERIFIKASI.RAB_GEDUNG.VERIFIKATOR_ASET.script")
