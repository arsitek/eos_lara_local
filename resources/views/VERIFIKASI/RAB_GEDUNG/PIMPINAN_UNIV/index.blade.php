                        ...
                        <table class="tabel-vergdg table table-bordered border mb-0" id="new-edit">
                            ...
                            @foreach($rabgdg as $item)
                                <tr>
                                    ...
                                    <td> {{$item->kode_ikk}} | {{ $item->indikator_kinerja_kegiatan }} </td>
                                    ...
                                    <td>
                                        <label class="switch">
                                            ...
                                            {{ $item->verifikasi_pimpinan_univ == 'Setuju' ? 'checked' : ''}} @if( $isVerifikator == false ) disabled @endif>
...
@endsection
@push("scripts")
    @include("VERIFIKASI.RAB_GEDUNG.PIMPINAN_UNIV.script")
