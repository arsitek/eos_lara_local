            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="tabel-verlangganan table table-bordered border mb-0">
                            <thead>
                                <tr>
                            ...
                            @foreach($rablangganan as $item)
                                <tr>
                                    ...
                                    <td>{{
                                        ...
                                        $item->biaya_satuan}}</td>
                                    <td> {{ $item->formatted_jumlah_biaya }} </td>
                                    <td>
                                        <label class="switch">
                                        <input type="checkbox" class="switchVerifikasi" data-jenis="verifikasiSpi"
                                        {{ $item->verifikasi_spi == 'Setuju' ? 'checked' : ''}} @if( $isVerifikator == false ) disabled @endif>
...
@push("scripts")
    ...
    @include("VERIFIKASI.RAB_LANGGANAN.SPI.script")
