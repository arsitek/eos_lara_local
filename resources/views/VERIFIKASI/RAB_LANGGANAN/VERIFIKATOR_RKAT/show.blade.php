        ...
        <div class="col-lg-12">
            <div class="card relative">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="tabel-verlangganan table table-bordered border mb-0" id="new-edit">
                            ...
                            <tr>
                                ...
                                <th rowspan="2" class="align-middle text-center">Rincian Output</th>
                                <th rowspan="2" class="align-middle text-center">Komponen</th>
                                <th rowspan="2" class="align-middle text-center">Sub Komponen</th>
                                <th rowspan="2" class="align-middle text-center">Detail Kegiatan</th>
                                <th rowspan="2" class="align-middle text-center">tor</th>
                                <th rowspan="2" class="align-middle text-center">Jenis<span style="visibility:hidden;">_</span>Belanja</th>
                                <th rowspan="2" class="align-middle text-center">RPD</th>
                                <th rowspan="2" class="align-middle text-center">Kebutuhan Kegiatan</th>
                                <th rowspan="2" class="align-middle text-center">spesifikasi</th>
                                <th rowspan="2" class="align-middle text-center">Biaya satuan (Rp)</th>
                                <th rowspan="2" class="align-middle text-center">Jumlah Biaya (Rp)</th>
                                @if( $isCrud == 1 )
                                <th colspan="5" class="align-middle text-center">Verifikator</th>
                                <th rowspan="2" class="align-middle text-center">tanggapan</th>
                            ...
                            <tr>
                                ...
                                <td class="tor">
                                    @if(!empty($item->tor))
                                        <div class="document-link-container">
                                            <a href="/rekat/tor?id={{ $item->id_rekat }}" class="document-link" target="_blank" data-id="{{ $item->id_rekat }}" data-subjudul="{{ $item->sub_judul }}">
                                ...
                                @if( $isCrud == 1 )
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn-edit-modal text-white" href="/verifikasi/langganan/edit/{{ $item->id }}?kd_sumberdana={{ $kd_sumberdana}}" target="_blank">
                    ...
                    @include("VERIFIKASI.RAB_LANGGANAN.modalSetuju")
...
@push("scripts")
    @include("VERIFIKASI.RAB_LANGGANAN.script")
