...
$(document).ready(function() {
    ...
    const tbodyVerLangganan  = $(".tabel-verlangganan tbody")
    ...
    $( document ).on("click", ".btn-save", function() {
        ...
        $.ajax({
            type: "POST", url: "{{ route("vRabLangganan.store") }}",
        ...
        return data.reduce( ( html, item, index ) => {
            ...
            return html + `
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a class="btn-edit-modal text-white" href="/verifikasi/langganan/edit/${item.id}?kd_sumberdana=${item.sumberdana}" target="_blank">
