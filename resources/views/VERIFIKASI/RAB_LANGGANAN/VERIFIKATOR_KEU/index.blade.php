                        ...
                        <table class="tabel-verlangganan table table-bordered border mb-0" id="new-edit">
                            ...
                            @foreach($rablangganan as $item)
                                <tr>
                                    ...
                                    <td> {{ $item->rpd_rekat ?? $item->rpd }} </td>
                                    <td>
                                        <select name="jenis_belanja" style="width:300px" class="s jenis_belanja">
                                            <option value="{{ $item->id_jenis_belanja }}" selected>[{{ $item->id_jenis_belanja }}] {{ $item->jenis_belanja }}</option>
                                            @foreach($jenis_belanja as $item_coa)
                                                <option value="{{ $item_coa['id_coa'] }}">{{ '['.$item_coa['id_coa'].']'.' '.  $item_coa['coa'] }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td> {{ $item->rpd }} </td>
...
@push("scripts")
    ...
    @include("VERIFIKASI.RAB_LANGGANAN.VERIFIKATOR_KEU.script")
