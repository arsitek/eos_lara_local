...
@section('content')
  ...
  <div class="card mb-6">
    <div class="card-header">
      <h5 class="card-title mb-0">Distribusi per Jenis RAB</h5>
    </div>
    <div class="card-body">
      <div class="row align-items-center">
        <!-- Donut Chart -->
        <div class="col-md-4">
          <div style="position: relative; width: 100%; height: 220px;">
            <div id="jenisRabDonutChart"></div>
            <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center;">
              <p style="font-size: 11px; color: #6c757d; margin: 0;">Total</p>
              <p style="font-size: 17px; font-weight: 500; margin: 0; color: #5D596C;" id="jenisRabTotal">Rp0</p>
            </div>
          </div>
        </div>
        ...
        <!-- Detail Cards -->
        <div class="col-md-8">
          <div id="jenisRabDetails" style="display: flex; flex-direction: column; gap: 10px;">
